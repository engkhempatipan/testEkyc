package com.my.ekyc.ui.detail.activity
...
import com.my.ekyc.ui.detail.adapter.ScreenSlidePagerAdapter
import com.my.ekyc.ui.detail.anim.ZoomOutPageTransformer
...
class DetailActivity : AppCompatActivity(), DetailContract.View {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupImagePager()
        id?.let {
            detailPresenter.getImagesById(it)
        }
